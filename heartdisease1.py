...
## Base Learners for pca componet analysis by usign kcorss fold
clfs = []
...
#catboost fine tuning weighteges
...
print('catboost The accuracy weighted average classifier is :', weighted_avg.score(x_test,y_test))
...
print('catboost weighted_average_accuracy: ',weighted_avg.score(x_test, y_test))
print('\n')
...
print('cat boost Average accuracy score: ',weighted_avg.score(x_test, y_test))
